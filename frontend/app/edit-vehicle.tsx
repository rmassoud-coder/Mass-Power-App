...
export default function EditVehicleScreen() {
  ...
  const [vin, setVin] = useState(params.vin as string);
  const [plateNumber, setPlateNumber] = useState(params.plateNumber as string);
  const [make, setMake] = useState(params.make as string);
  const [model, setModel] = useState(params.model as string);
  const [year, setYear] = useState((params.year as string) || '');
...
const styles = StyleSheet.create({
  ...
  decodeButtonDisabled: { opacity: 0.6 },
  submitButton: {
