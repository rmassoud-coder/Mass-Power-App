      ...
      <ScrollView style={styles.content}>
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>
            Save all your customers, vehicles, services, and inventory to a backup file.
          </Text>
          <TouchableOpacity
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            All your data is stored locally. Backups are JSON files you can save to email, cloud drives, or transfer between devices.
          </Text>
        </View>
      </ScrollView>
